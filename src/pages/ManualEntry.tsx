        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            field
                  ...
                  <FormControl>
                    <Input placeholder="Air Max, Cloudrunner, Sky lifestyle etc." className="h-12 text-base" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>} />
              ...
              <div className="flex gap-2">
                ...
                <div className="w-2/3">
                  ...
                  field
                        ...
                        <FormControl>
                          <Input placeholder="Enter size number" inputMode="decimal" pattern="[0-9]*\.?[0-9]*" className="h-12 text-base" required {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>} />
                </div>
