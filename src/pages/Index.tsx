...
// No need for useAuth or supabase imports anymore
...
const Index = () => {
  ...
  // Remove logout handler and login/signup UI
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 flex flex-col relative overflow-hidden">
      ...
      {/* Removed Login/Logout UI header */}
      <div className="flex justify-end items-center px-6 pt-4">{/* intentionally left blank */}</div>
