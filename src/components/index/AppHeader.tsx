      ...
      <div className="relative max-w-sm mx-auto">
        ...
        <div className="group relative bg-white/80 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl shadow-green-500/10 transition-all duration-700 ease-out hover:scale-[1.02] hover:shadow-3xl hover:shadow-green-500/20 hover:bg-white/90">
          ...
          <div className="relative z-10 mb-8">
            <div className="group/logo bg-gradient-to-br from-white to-gray-50/50 backdrop-blur-sm rounded-2xl shadow-lg shadow-black/5 p-6 mx-auto w-28 h-28 flex items-center justify-center mb-6 transition-all duration-500 ease-out hover:scale-105 hover:shadow-xl hover:shadow-green-500/10 border border-white/40 px-[8px] py-[8px]">
            ...
            <div className="space-y-2">
              ...
              <div className="inline-flex items-center justify-center">
                <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold px-3 py-1 rounded-full shadow-lg shadow-green-500/25 border border-green-400/20 text-2xl">
                  Beta
                </span>
              </div>
            </div>
          ...
          <div className="absolute bottom-4 left-4 w-1.5 h-1.5 bg-gradient-to-r from-emerald-400 to-teal-400 rounded-full opacity-40 animate-pulse" style={{
          animationDelay: '1s'
        }}></div>
        </div>
