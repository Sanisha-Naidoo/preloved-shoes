-- Drop and recreate preloved schema functions to work with actual table structure
...
DROP FUNCTION IF EXISTS preloved.update_qr_code(uuid, text);

-- Recreate get_shoe_count function
...
-- Recreate get_shoes_for_notion function  
...
-- Recreate create_shoe function with proper parameter order
...
-- Recreate check_shoe_exists function
...
-- Recreate update_qr_code function
